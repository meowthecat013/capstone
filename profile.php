...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['update_profile'])) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE users SET full_name = ?, email = ?, preferred_language = ? WHERE id = ?");
            if ($stmt->execute([$full_name, $email, $language, $userId])) {
...
<head>
    ...
    <title>NeuroAid Health - My Account</title>
    ...
    <style>
        * {
        ...
        .account-section.active, .password-section.active {
            display: block;
        }
...
<body>
        ...
        <main class="content-area">
            ...
            <div class="account-container">
                ...
                <div class="account-header">
                    <img src="image/anjanet.png" alt="User Photo" class="profile-image">
                    <h2>My Account</h2>
                    <button class="btn" onclick="showSection('account')">Change Photo</button>
                </div>
                
                <div class="btn-group">
                    <button class="btn active" onclick="showSection('account')">Account Details</button>
                    <button class="btn" onclick="showSection('password')">Password Settings</button>
                </div>

                <form method="POST" action="">
                    <div class="account-section active" id="account-section">
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="language" value="<?php echo htmlspecialchars($userData['preferred_language'] ?? 'English'); ?>">
                        </div>
    ...
    <script>
        ...
        function showSection(section) {
            // Hide all sections
            document.querySelectorAll('.account-section, .password-section').forEach(el => {
