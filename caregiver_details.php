...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $caregiver_relationship = $_POST['caregiver_relationship'];
    $caregiver_phone = $_POST['caregiver_phone'];
    ...
    try {
        ...
        if ($stmt->execute([
            ...
            $caregiver_phone, $caregiver_email, $userId
        ])) {
            $_SESSION['success'] = "Caregiver details updated successfully!";
            $userData = getUserData($userId); // Refresh user data
        } else {
            $_SESSION['error'] = "Failed to update caregiver details.";
        }
...
<head>
    ...
    <title>NeuroAid Health - Caregiver Details</title>
    ...
    <div class="main-container">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="has-dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="user_details.php"><i class="fas fa-user-edit"></i> Patients</a></li>
                        <li class="active"><a href="caregiver_details.php"><i class="fas fa-hands-helping"></i> Caregiver</a></li>
                    </ul>
                </li>
                <li>
                    <a href="settings.php">
        ...
        <main class="content-area">
            ...
            <div class="welcome-section">
                <h2 class="welcome-title">Caregiver Information</h2>
                <p class="welcome-subtitle">Please provide details about your primary caregiver</p>
            </div>
                    ...
                    <div class="details-container">
                        <form method="POST" action="">
                            <div class="form-section">
                                <h3 class="section-title">Primary Caregiver</h3>
                                <div class="form-row">
                                    <div class="form-group">
                                        <label>Caregiver Name</label>
                                        <input type="text" name="caregiver_name" value="<?php echo htmlspecialchars($userData['caregiver_name']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Relationship</label>
                                        <input type="text" name="caregiver_relationship" value="<?php echo htmlspecialchars($userData['caregiver_relationship']); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                        <label>Phone Number</label>
                                        <input type="text" name="caregiver_phone" value="<?php echo htmlspecialchars($userData['caregiver_phone']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Email Address</label>
                                        <input type="email" name="caregiver_email" value="<?php echo htmlspecialchars($userData['caregiver_email']); ?>">
                                    </div>
                                </div>
                            </div>
                            
                            <button type="submit" class="save-btn">Save Caregiver Information</button>
                        </form>
                    </div>
                </div>
            </div>
